...
4. 계획을 보고한다. Codex의 선택 UI를 사용할 수 있으면 사용하고, 그렇지 않으면 [연결하기/건너뛰기/수정] 중 하나를 명확히 질문해 답을 받은 뒤 진행한다.
...
3. Codex의 선택 UI를 사용할 수 있으면 사용하고, 그렇지 않으면 [만들기(갱신)/건너뛰기/대상 수정] 중 하나를 명확히 질문해 답을 받은 뒤 진행한다.
